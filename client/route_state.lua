...
function RouteState.BuildReceiverPayload(minimal)
    ...
    if not activeContract then
        return {
            ...
            label = 'DISPATCH STANDBY',
            stage = 'No active route',
            notice = 'No freight route assigned. Open dispatch to select a contract.',
            currentStop = 0,
            totalStops = 0,
            payout = 0,
            cargo = 'No active load',
            destination = 'LS Freight Dispatch',
            destinationAddress = 'TERMINAL STANDBY',
            ...
            gpsLocked = gpsLocked,
            dockEnabled = Config.ReceiverDockEnabled ~= false,
            dockVisible = false,
            ...
            cargoConditionLabel = 'NO ACTIVE LOAD',
    ...
    return {
        ...
        gpsLocked = gpsLocked,
        dockEnabled = Config.ReceiverDockEnabled ~= false,
        dockVisible = Config.ReceiverDockEnabled ~= false and not dockHidden,
        dockUserHidden = dockHidden,
