...
function renderDispatchHomeLegend(data = dispatchData) {
...
function renderDispatchHome(data = dispatchData) {
    ...
    const legendHtml = renderDispatchHomeLegend(data);
...
function setupMovablePanel(options) {
    ...
    function startDrag(event) {
        ...
        if (activePointerId !== null && box.setPointerCapture) {
            try { box.setPointerCapture(activePointerId); } catch (e) {}
        }
    ...
    function stopDrag(event) {
        ...
        if (activePointerId !== null && box.releasePointerCapture) {
            try { box.releasePointerCapture(activePointerId); } catch (e) {}
        }
