...
const previewDispatch = {
    ...
    vehicles: {
        van: [
            { type: 'van', index: 1, label: 'Speedo Express', model: 'speedo', plate: 'LSF 214', minRank: 1, stored: true, photo: '../images/photos/vehicles/speedo.png' },
            { type: 'van', index: 2, label: 'Rumpo Custom', model: 'rumpo', plate: 'LSF 618', minRank: 2, stored: true, photo: '../images/photos/vehicles/rumpo.png' }
        ],
        boxtruck: [
            { type: 'boxtruck', index: 1, label: 'Mule Freight', model: 'mule', plate: 'LSF 502', minRank: 1, stored: true, photo: '../images/photos/vehicles/mule2.png' },
            { type: 'boxtruck', index: 2, label: 'Pounder Custom', model: 'pounder', plate: 'LSF 733', minRank: 3, stored: false, photo: '../images/photos/vehicles/pounder.png' }
        ],
        trailer: [
            { type: 'trailer', index: 1, label: 'Phantom + Dry Van', model: 'phantom', plate: 'LSF 900', minRank: 2, stored: true, photo: '../images/photos/vehicles/phantom.png' }
        ]
    },
    garage: [
        { type: 'van', index: 1, label: 'Speedo Express', plate: 'LSF 214', minRank: 1, stored: true, photo: '../images/photos/vehicles/speedo.png' },
        { type: 'boxtruck', index: 1, label: 'Mule Freight', plate: 'LSF 502', minRank: 1, stored: true, photo: '../images/photos/vehicles/mule2.png' },
        { type: 'trailer', index: 1, label: 'Phantom + Dry Van', plate: 'LSF 900', minRank: 2, stored: true, photo: '../images/photos/vehicles/phantom.png' }
    ],
    priorityLoads: {
        van: { ...priorities },
        boxtruck: { ...priorities },
    ...
    routeTrailers: {
        dryvan: { label: 'Dry Van Trailer', model: 'trailers2', photo: '../images/photos/trailers/dryvan.png' }
    },
    reuse: {
        available: true,
        type: 'boxtruck',
    ...
    contractor: {
        ...
        maxOwnedVehicles: 6,
        vehicles: [
            { id: 101, type: 'boxtruck', typeLabel: 'Box Truck', index: 2, label: 'Pounder Custom', plate: 'PC 101', stored: false, out: true, fuel: 87, condition: 94, mileage: 153.7, originalPrice: 42500, resalePrice: 38250, photo: '../images/photos/vehicles/pounder.png' }
        ],
        dailyRoutes: [
        ...
        market: [
            { type: 'van', index: 1, typeLabel: 'Van', label: 'Speedo Express', price: 18000, minRank: 1, owned: false, photo: '../images/photos/vehicles/speedo.png' },
            { type: 'boxtruck', index: 2, typeLabel: 'Box Truck', label: 'Pounder Custom', price: 42500, minRank: 3, owned: true, photo: '../images/photos/vehicles/pounder.png' }
        ]
    },
    companyStats: {
